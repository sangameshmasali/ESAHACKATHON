...
export class SavedConfigurationComponent implements OnInit {
  ...
  addConfiguration() {
    // local storage empty
    this.genericConfigurationService.masterData.value.configurationDetails = null;
    this.genericConfigurationService.masterData.value.controllerProductSettings = null;
    this.genericConfigurationService.masterData.value.washersettings = null;
    this.genericConfigurationService.masterData.value.formula = null;
    this.genericConfigurationService.masterData.value.isEditFlag = false;
    this.genericConfigurationService.masterData.value.storePreviousConfigId = null;
    this.genericConfigurationService.masterData.value.OneditStoreSelectedData = null;
    this.genericConfigurationService.masterData.value.oNeditStoreSelectedRegion = null;
    this.genericConfigurationService.masterData.value.facility = null;
    this.genericConfigurationService.masterData.value.watersettings = null;
    this.genericConfigurationService.masterData.value.dateAndTime = this.genericConfigurationService.getUtcDate(true);
    this.genericConfigurationService.setLocalStorage(this.genericConfigurationService.masterData.value);
    this.router.navigate(['dashboard/configuration/configuration-details']);
  }
  getTranslation() {
    this.translate.get([
